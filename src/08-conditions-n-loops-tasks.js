...
function evaluateTicTacToePosition(position) {
  ...
  for (const pos of winCombintions) {
    if (position[pos[0][0]][pos[0][1]]
&& position[pos[0][0]][pos[0][1]] === position[pos[1][0]][pos[1][1]]
&& position[pos[0][0]][pos[0][1]] === position[pos[2][0]][pos[2][1]]) {
      return position[pos[0][0]][pos[0][1]];
    }
  }
  return undefined;
}
